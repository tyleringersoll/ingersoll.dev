        ...
        <div class="hv2-two-col">
          ...
          <div class="hv2-engineering__right">
            ...
            <div class="hv2-btn-wrap">
              <router-link to="/resume" class="hv2-btn hv2-btn--primary">{{ eng.cta }}</router-link>
            </div>
          </div>
      ...
      <div class="hv2-inner">
        <div class="hv2-two-col">
          ...
          <div class="hv2-music__right">
            ...
            <div class="hv2-btn-wrap">
              <router-link to="/music" class="hv2-btn hv2-btn--primary">{{ mus.cta }}</router-link>
            </div>
          </div>
...
// Home article sections, looked up by id
...
.hv2-comp-icon {
  ...
  // SVG is injected via v-html, so scoped styles require :deep
  :deep(svg) {
    width: 18px;
    height: 18px;
    flex-shrink: 0;
...
.hv2-social-circle {
  ...
  // The circle disk wraps the SVG via v-html
  &__disk {
    width: 76px;
    height: 76px;
    border-radius: 50%;
    ...
    // Override inline fill/size on SVGs from content.js
    :deep(svg),
    :deep(svg path),
    :deep(svg circle),
    :deep(svg polygon) {
